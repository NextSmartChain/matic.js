...
This repository contains the `nextjs` client library and will help developers to move assets from Ethereum chain to NEXT Smart Chain, and withdraw from NEXT Smart Chain to Ethereum using fraud proofs.
